...
Optiland supports four field specification types:
...
* Real image height (`real_image_height`): Field positions specified by real chief ray heights at the image plane
