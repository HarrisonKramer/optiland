...
This learning guide breaks down the Optiland library into a series of tutorials that cover the basic concepts and functionalities of the library. Each tutorial is a self-contained Jupyter notebook that demonstrates how to perform a specific task using Optiland. The tutorials are designed to be followed sequentially, starting with an introduction to Optiland and progressing to more advanced topics.
