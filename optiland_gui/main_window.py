...
# CUSTOM_TITLE_BAR_QSS_PATH will no longer be used directly in load_stylesheets
# CUSTOM_TITLE_BAR_QSS_PATH = os.path.join(
#     os.path.dirname(__file__), "resources", "styles", "custom_title_bar.qss"
# )
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self._actual_menu_bar_instance = QMenuBar(
            self
        )  # This QMenuBar will be put into the CustomTitleBar #
        ...
        )  # Add CustomTitleBar QWidget here #
        ...
        self.quick_actions_toolbar.setMovable(
            True
        )  # Allow moving if desired, or set to False #
        self._populate_quick_actions_toolbar(self.quick_actions_toolbar)  #
        self.addToolBarBreak(
            Qt.TopToolBarArea
        )  # Force quick_actions_toolbar to a new line below title_bar_as_toolbar #
    ...
    def _populate_main_menu_bar(self, menu_bar: QMenuBar):  #
        ...
        if hasattr(self, "viewerDock") and self.viewerDock:  #
            self.viewerDock.toggleViewAction().setText(
                "Toggle System Viewer"
            )  # Ensure text #
        ...
        if hasattr(self, "systemPropertiesDock") and self.systemPropertiesDock:  #
            self.systemPropertiesDock.toggleViewAction().setText(
                "Toggle System Properties"
            )  #
        ...
        if hasattr(self, "analysisPanelDock") and self.analysisPanelDock:  #
            self.analysisPanelDock.toggleViewAction().setText(
        ...
        if hasattr(self, "optimizationPanelDock") and self.optimizationPanelDock:  #
            self.optimizationPanelDock.toggleViewAction().setText(
    ...
    def _create_actions(self):  #
        ...
        self.dockAllAction = QAction(
            "Dock All Windows", self, triggered=self.dock_all_windows_action
        )  #
    ...
    def load_stylesheets(self):  #
        ...
        # MODIFICATION: Removed loading of custom_title_bar.qss
        # Styles for the custom title bar will now be part of the main theme files.
    ...
    def dock_all_windows_action(self):  #
        print(
            "Main Window: Dock All Windows action triggered - resetting to revised default layout."
        )
        self._apply_revised_default_dock_layout()  #
        for dock in self.all_managed_docks:  #
