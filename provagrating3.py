...
#lens.add_surface(index=3, radius=100, thickness=30, surface_type="grating", p = 3.0, m = 1, ga = 0, is_stop=True)
...
rays = lens.trace(Hx=0, Hy=0, wavelength=0.587, num_rays=5, distribution="random")
