"""
Define functions used to find the NURBS parameters that approximate a given set of points.
Most of the code is derived from nurbs-geomdl package written by Onur R. Bingol <contact@onurbingol.net>
