...
class GridSagGeometry(BaseGeometry):
    ...
    def _interpolate(self, x, y):
        ...
        # be.searchsorted returns the index where the element should be inserted
        # which is equivalent to the index of the first element that is larger.
        # So we subtract 1 to get the lower bound index.
