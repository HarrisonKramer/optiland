...
class Sphere(BaseGeometry):
    """Represents a sphere geometry in a given coordinate system.

    Args:
        coordinate_system (str): The coordinate system used for the sphere.
    ...
    def sag(self, x=0, y=0):
        """Calculate the surface sag of the sphere at a given point.
        ...
        Returns:
            float: The surface sag of the sphere at the given point.
        """
        r2 = x**2 + y**2
        return r2 / (self.radius + np.sqrt(self.radius**2 - r2))

    def distance(self, rays):
        """Find the propagation distance to the sphere from a given ray.
    ...
    def surface_normal(self, rays):
        """Find the surface normal of the sphere at a given point.
        ...
        denom = -self.radius * np.sqrt(1 - r2 / self.radius**2)
        dfdx = rays.x / denom
        dfdy = rays.y / denom
        dfdz = 1
