...
class RealRays(BaseRays):
    ...
    def gratingdiffract_tmp(self, nx, ny, nz, fx, fy, fz, m, d, n1, n2, is_reflective):
        """Diffract the rays on the surface.
