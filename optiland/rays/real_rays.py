...
class RealRays(BaseRays):
    ...
    def gratingdiffract_p(self, nx, ny, nz, fx, fy, fz, m, d, n1, n2, is_reflective):
        ...
        uy = sgn*uy/n2
        uz = sgn*uz/n2
        a = 1. - (ux**2+uy**2+uz**2)+(nx**2*ux**2 + ny**2*uy**2 + nz**2*uz**2)
        a = be.sqrt(a)
        a = a - (nx*ux+ny*uy+nz*uz)
    ...
    def gratingdiffract(self, nx, ny, nz, fx, fy, fz, m, d, n1, n2, is_reflective):
        ...
        if(is_reflective):
            sgn = -1
            n2c = n2*sgn
#            self.L = (self.L0*d*n1*ny**2 + self.L0*d*n1*nz**2 - self.M0*d*n1*nx*ny - self.N0*d*n1*nx*nz + fx*m*ny**2*self.w + fx*m*nz**2*self.w - fy*m*nx*ny*self.w - fz*m*nx*nz*self.w - nx*be.sqrt(-self.L0**2*d**2*n1**2*ny**2 - self.L0**2*d**2*n1**2*nz**2 + 2*self.L0*self.M0*d**2*n1**2*nx*ny + 2*self.L0*self.N0*d**2*n1**2*nx*nz - 2*self.L0*d*fx*m*n1*ny**2*self.w - 2*self.L0*d*fx*m*n1*nz**2*self.w + 2*self.L0*d*fy*m*n1*nx*ny*self.w + 2*self.L0*d*fz*m*n1*nx*nz*self.w - self.M0**2*d**2*n1**2*nx**2 - self.M0**2*d**2*n1**2*nz**2 + 2*self.M0*self.N0*d**2*n1**2*ny*nz + 2*self.M0*d*fx*m*n1*nx*ny*self.w - 2*self.M0*d*fy*m*n1*nx**2*self.w - 2*self.M0*d*fy*m*n1*nz**2*self.w + 2*self.M0*d*fz*m*n1*ny*nz*self.w - self.N0**2*d**2*n1**2*nx**2 - self.N0**2*d**2*n1**2*ny**2 + 2*self.N0*d*fx*m*n1*nx*nz*self.w + 2*self.N0*d*fy*m*n1*ny*nz*self.w - 2*self.N0*d*fz*m*n1*nx**2*self.w - 2*self.N0*d*fz*m*n1*ny**2*self.w + d**2*n2c**2*nx**2 + d**2*n2c**2*ny**2 + d**2*n2c**2*nz**2 - fx**2*m**2*ny**2*self.w**2 - fx**2*m**2*nz**2*self.w**2 + 2*fx*fy*m**2*nx*ny*self.w**2 + 2*fx*fz*m**2*nx*nz*self.w**2 - fy**2*m**2*nx**2*self.w**2 - fy**2*m**2*nz**2*self.w**2 + 2*fy*fz*m**2*ny*nz*self.w**2 - fz**2*m**2*nx**2*self.w**2 - fz**2*m**2*ny**2*self.w**2))/(d*n2c*(nx**2 + ny**2 + nz**2))
#            self.M = (-self.L0*d*n1*nx*ny + self.M0*d*n1*nx**2 + self.M0*d*n1*nz**2 - self.N0*d*n1*ny*nz - fx*m*nx*ny*self.w + fy*m*nx**2*self.w + fy*m*nz**2*self.w - fz*m*ny*nz*self.w - ny*be.sqrt(-self.L0**2*d**2*n1**2*ny**2 - self.L0**2*d**2*n1**2*nz**2 + 2*self.L0*self.M0*d**2*n1**2*nx*ny + 2*self.L0*self.N0*d**2*n1**2*nx*nz - 2*self.L0*d*fx*m*n1*ny**2*self.w - 2*self.L0*d*fx*m*n1*nz**2*self.w + 2*self.L0*d*fy*m*n1*nx*ny*self.w + 2*self.L0*d*fz*m*n1*nx*nz*self.w - self.M0**2*d**2*n1**2*nx**2 - self.M0**2*d**2*n1**2*nz**2 + 2*self.M0*self.N0*d**2*n1**2*ny*nz + 2*self.M0*d*fx*m*n1*nx*ny*self.w - 2*self.M0*d*fy*m*n1*nx**2*self.w - 2*self.M0*d*fy*m*n1*nz**2*self.w + 2*self.M0*d*fz*m*n1*ny*nz*self.w - self.N0**2*d**2*n1**2*nx**2 - self.N0**2*d**2*n1**2*ny**2 + 2*self.N0*d*fx*m*n1*nx*nz*self.w + 2*self.N0*d*fy*m*n1*ny*nz*self.w - 2*self.N0*d*fz*m*n1*nx**2*self.w - 2*self.N0*d*fz*m*n1*ny**2*self.w + d**2*n2c**2*nx**2 + d**2*n2c**2*ny**2 + d**2*n2c**2*nz**2 - fx**2*m**2*ny**2*self.w**2 - fx**2*m**2*nz**2*self.w**2 + 2*fx*fy*m**2*nx*ny*self.w**2 + 2*fx*fz*m**2*nx*nz*self.w**2 - fy**2*m**2*nx**2*self.w**2 - fy**2*m**2*nz**2*self.w**2 + 2*fy*fz*m**2*ny*nz*self.w**2 - fz**2*m**2*nx**2*self.w**2 - fz**2*m**2*ny**2*self.w**2))/(d*n2c*(nx**2 + ny**2 + nz**2))
#            self.N = -nz*be.sqrt(-self.L0**2*d**2*n1**2*ny**2 - self.L0**2*d**2*n1**2*nz**2 + 2*self.L0*self.M0*d**2*n1**2*nx*ny + 2*self.L0*self.N0*d**2*n1**2*nx*nz - 2*self.L0*d*fx*m*n1*ny**2*self.w - 2*self.L0*d*fx*m*n1*nz**2*self.w + 2*self.L0*d*fy*m*n1*nx*ny*self.w + 2*self.L0*d*fz*m*n1*nx*nz*self.w - self.M0**2*d**2*n1**2*nx**2 - self.M0**2*d**2*n1**2*nz**2 + 2*self.M0*self.N0*d**2*n1**2*ny*nz + 2*self.M0*d*fx*m*n1*nx*ny*self.w - 2*self.M0*d*fy*m*n1*nx**2*self.w - 2*self.M0*d*fy*m*n1*nz**2*self.w + 2*self.M0*d*fz*m*n1*ny*nz*self.w - self.N0**2*d**2*n1**2*nx**2 - self.N0**2*d**2*n1**2*ny**2 + 2*self.N0*d*fx*m*n1*nx*nz*self.w + 2*self.N0*d*fy*m*n1*ny*nz*self.w - 2*self.N0*d*fz*m*n1*nx**2*self.w - 2*self.N0*d*fz*m*n1*ny**2*self.w + d**2*n2c**2*nx**2 + d**2*n2c**2*ny**2 + d**2*n2c**2*nz**2 - fx**2*m**2*ny**2*self.w**2 - fx**2*m**2*nz**2*self.w**2 + 2*fx*fy*m**2*nx*ny*self.w**2 + 2*fx*fz*m**2*nx*nz*self.w**2 - fy**2*m**2*nx**2*self.w**2 - fy**2*m**2*nz**2*self.w**2 + 2*fy*fz*m**2*ny*nz*self.w**2 - fz**2*m**2*nx**2*self.w**2 - fz**2*m**2*ny**2*self.w**2)/(d*n2c*(nx**2 + ny**2 + nz**2)) - (self.L0*d*n1*nx*nz + self.M0*d*n1*ny*nz - self.N0*d*n1*nx**2 - self.N0*d*n1*ny**2 + fx*m*nx*nz*self.w + fy*m*ny*nz*self.w - fz*m*nx**2*self.w - fz*m*ny**2*self.w)/(d*n2c*(nx**2 + ny**2 + nz**2))
